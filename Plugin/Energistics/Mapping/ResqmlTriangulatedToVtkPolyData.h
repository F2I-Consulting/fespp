...
public:
	 ...
	 * Constructor
	 */
	ResqmlTriangulatedToVtkPolyData(const RESQML2_NS::TriangulatedSetRepresentation *triangulated, uint64_t patch_index, uint32_t p_procNumber = 0, uint32_t p_maxProc = 1);
