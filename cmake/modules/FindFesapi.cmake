...
if(NOT FESAPI_FOUND)
	...
	find_library(FESAPI_LIBRARY_RELEASE NAMES ${FESAPI_DIR}/lib/libFesapiCpp.1.1.0.0.so 
 		PATHS	${FESAPI_DIR}/lib/)
		
	find_library(FESAPI_LIBRARY_DEBUG NAMES ${FESAPI_DIR}/lib/libFesapiCppd.1.1.0.0.so 
 		PATHS	${FESAPI_DIR}/lib/)
